...
<body>
    <form id="form1" runat="server">
        ...
        <div id="post-job-section" class="section">
            ...
            <div id="post-job-form" class="post-job-form">
                ...
                <asp:RequiredFieldValidator ID="rfvJobTitle" runat="server" ControlToValidate="JobTitleTextBox" ErrorMessage="Job Title is required" CssClass="text-danger" Display="Dynamic" ValidationGroup="PostJob" />
                <br />
                ...
                <asp:RequiredFieldValidator ID="rfvExperience" runat="server" ControlToValidate="ExperienceTextBox" ErrorMessage="Experience is required" CssClass="text-danger" Display="Dynamic" ValidationGroup="PostJob" />
                <br />
                ...
                <asp:RequiredFieldValidator ID="rfvSalary" runat="server" ControlToValidate="SalaryTextBox" ErrorMessage="Salary is required" CssClass="text-danger" Display="Dynamic" ValidationGroup="PostJob" />
                <br />
                ...
                <asp:RequiredFieldValidator ID="rfvDeadline" runat="server" ControlToValidate="DeadlineTextBox" ErrorMessage="Deadline is required" CssClass="text-danger" Display="Dynamic" ValidationGroup="PostJob" />
                <br />
                ...
                <asp:RequiredFieldValidator ID="rfvPublishDate" runat="server" ControlToValidate="PublishDateTextBox" ErrorMessage="Publish Date is required" CssClass="text-danger" Display="Dynamic" ValidationGroup="PostJob" />
                <br />
                ...
                <asp:RequiredFieldValidator ID="rfvVacancy" runat="server" ControlToValidate="VacancyTextBox" ErrorMessage="Vacancy is required" CssClass="text-danger" Display="Dynamic" ValidationGroup="PostJob" />
                <asp:RangeValidator ID="rvVacancy" runat="server" ControlToValidate="VacancyTextBox" MinimumValue="1" MaximumValue="100" Type="Integer" ErrorMessage="Vacancy must be between 1 and 100" CssClass="text-danger" Display="Dynamic" ValidationGroup="PostJob" />
                <br />
                ...
                <asp:RequiredFieldValidator ID="rfvJobDescription" runat="server" ControlToValidate="JobDescriptionTextBox" ErrorMessage="Job Description is required" CssClass="text-danger" Display="Dynamic" ValidationGroup="PostJob" />
                <br />
                <asp:Button ID="PostJobButton" runat="server" CssClass="btn btn-primary" Text="Post Job" OnClick="PostJob_Click" ValidationGroup="PostJob" />
            </div>
        </div>
    ...
    <div id="update-profile-form" class="form-card">
       ...
       <!-- Company Name -->
        ...
        <asp:RequiredFieldValidator ID="rfvCompanyName" runat="server" ControlToValidate="CompanyNameTextBox" ErrorMessage="Company Name is required" CssClass="text-danger" Display="Dynamic" ValidationGroup="UpdateProfile" />
        ...
        <asp:RequiredFieldValidator ID="rfvCompanyEmail" runat="server" ControlToValidate="CompanyEmailTextBox" ErrorMessage="Company Email is required" CssClass="text-danger" Display="Dynamic" ValidationGroup="UpdateProfile" />
        <asp:RegularExpressionValidator ID="revCompanyEmail" runat="server" ControlToValidate="CompanyEmailTextBox" ErrorMessage="Invalid email format" ValidationExpression="^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$" CssClass="text-danger" Display="Dynamic" ValidationGroup="UpdateProfile" />
        <br />
        ...
        <asp:RequiredFieldValidator ID="rfvCompanyAddress" runat="server" ControlToValidate="CompanyAddressTextBox" ErrorMessage="Company Address is required" CssClass="text-danger" Display="Dynamic" ValidationGroup="UpdateProfile" />
        ...
        <asp:RequiredFieldValidator ID="rfvCompanyCity" runat="server" ControlToValidate="CompanyCityTextBox" ErrorMessage="Company City is required" CssClass="text-danger" Display="Dynamic" ValidationGroup="UpdateProfile" />

        <!-- Update Button -->
        <asp:Button ID="UpdateProfileButton" runat="server" CssClass="btn btn-primary" Text="Update" OnClick="UpdateProfileButton_Click" ValidationGroup="UpdateProfile" />
