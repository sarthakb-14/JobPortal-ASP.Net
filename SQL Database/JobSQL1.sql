...
CREATE TABLE student (
    ...
    sgender VARCHAR(10) NOT NULL CHECK (sgender IN ('Male', 'Female', 'Other')), -- Gender with predefined options
...
CREATE TABLE joblist (
    ...
    FOREIGN KEY (cid) REFERENCES company(cid) -- Foreign key constraint
);
...
CREATE TABLE applyjob (
    ...
    jobid INT NOT NULL,
    FOREIGN KEY (sid) REFERENCES student(sid),  -- Foreign key constraint
    FOREIGN KEY (jobid) REFERENCES joblist(jobid)  -- Foreign key constraint
);
